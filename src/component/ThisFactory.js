                        ...
                        <aside className="col-md-3 col-sm-4 col-xs-12">
                            <div className="blog-list">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <a href='thisfactory/view_product_by_year'>
                                            <i className="fa fa-caret-right"> </i>Thống kê sản phẩm đã bán theo năm
                                        </a>
                                    </li>
                                    <li>
                                        <a href="/thisfactory/statistic_failed_by_product_lines">
